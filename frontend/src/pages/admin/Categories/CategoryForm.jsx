  ...
  return (
    <div className="page page-enter">
      <PageHeader
        ...
        crumbs={[{ label: 'Categories', to: '/admin/categories' }, { label: isNew ? 'New' : 'Edit' }]}
        actions={
          <div style={{ display: 'flex', gap: 8 }}>
            ...
            <button className="btn btn-secondary" onClick={() => handleSave('inactive')} disabled={saving}>
              Save as Inactive
            </button>
                ...
                <div className="form-section">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                    <div className="field-group">
                      ...
                      <input className="field-input" value={form.name} placeholder="e.g. Shawls"
                        onChange={e => { set('name', e.target.value); if (!form.slug) set('slug', generateSlug(e.target.value)); }} />
                    </div>
                    <div className="field-group">
                      <label className="field-label">Slug</label>
                      <input className="field-input" value={form.slug} placeholder="shawls"
              ...
              <div className="card-body" style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                ...
                {(form.seo.title || form.name) && (
                  <div style={{ border: '1px solid var(--color-border)', borderRadius: 6, padding: '12px 14px', marginTop: 4 }}>
                    ...
                    <p style={{ fontSize: 11, color: '#006621' }}>zaevyul.com/categories/{form.seo.url || form.slug}</p>
                    <p style={{ fontSize: 12, color: '#545454', marginTop: 2, lineHeight: 1.4 }}>{form.seo.description || form.description}</p>
                  </div>
                )}
              </div>
            </div>
