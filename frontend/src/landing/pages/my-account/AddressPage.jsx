...
export default function AddressesSection() {
  ...
  return (
    <div className="min-h-screen bg-[#ffffff] font-sans px-6 sm:px-10 py-10">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-start justify-between gap-6 mb-10">
          <div>
            <h1 className="font-serif text-[34px] leading-tight text-[#1C1916] mb-2">
              Addresses
            </h1>
            <p className="text-[14px] text-[#7A7368] max-w-md leading-relaxed">
              Manage your saved addresses for a faster and smoother checkout
              experience.
            </p>
          </div>
          <button className="hidden sm:flex items-center gap-2 bg-[#F3EAE0] text-[#1C1916] text-[13px] font-medium px-5 py-3 rounded-md whitespace-nowrap hover:bg-[#ECDFCF] transition-colors cursor-pointer">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {addresses.map((addr) => (
            ...
            >
              ...
              <div className="text-[14px] text-[#3D3833] leading-relaxed">
          ...
          <button className="border border-dashed border-[#D8CFC0] rounded-lg flex flex-col items-center justify-center text-center py-12 px-6 min-h-[260px] hover:border-[#B08655] transition-colors cursor-pointer group">
